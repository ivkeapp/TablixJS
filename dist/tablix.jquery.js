...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.TablixJS = factory());
   ...
   */
  function initializeJQueryWrapper() {
    // Get jQuery from various sources
    const $ = typeof window !== 'undefined' && (window.jQuery || window.$) || typeof global !== 'undefined' && (global.jQuery || global.$) || (typeof require === 'function' ? (() => {
      try {
    ...
    function setupJQueryEventForwarding($element, instance) {
      ...
      const eventsToForward = ['beforeLoad', 'afterLoad', 'loadError', 'beforeSort', 'afterSort', 'beforeFilter', 'afterFilter', 'beforePageChange', 'afterPageChange', 'selectionChanged', 'selectAll'];
...
//# sourceMappingURL=tablix.jquery.js.map

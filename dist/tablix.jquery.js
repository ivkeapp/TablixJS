/**
 * TablixJS with jQuery Wrapper v0.1.1
...
(function (global, factory) {
  ...
  (function (factory) {
    ...
    const $ = isWindow && (window.jQuery || window.$) || isGlobal && (global.jQuery || global.$) || (typeof require === 'function' ? (() => {
      try {
    ...
    const Table = isWindow && window.TablixJS && window.TablixJS.Table || isWindow && window.TablixJS ||
    // If TablixJS is the Table class itself
    isGlobal && global.TablixJS && global.TablixJS.Table || isGlobal && global.TablixJS ||
    // If TablixJS is the Table class itself
    null;
    if (!Table) {
  ...
  if (typeof window !== 'undefined') {
    ...
    global.TablixJS = Table;
  }

  exports.TablixJS = Table;
